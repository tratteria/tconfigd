...
func TestParseTagsExtension(t *testing.T) {
	testCases := map[string]struct {
		...
		"simplest extension": {
			lines:              []string{`+genclient:method=TraT,verb=create`},
			expectedExtensions: []extension{{VerbName: "TraT", VerbType: "create"}},
		},
		"multiple extensions": {
			lines:              []string{`+genclient:method=TraT,verb=create`, `+genclient:method=Bar,verb=get`},
			expectedExtensions: []extension{{VerbName: "TraT", VerbType: "create"}, {VerbName: "Bar", VerbType: "get"}},
		},
		...
		"extension without verb type": {
			lines:       []string{`+genclient:method=TraT`},
			expectError: true,
		},
		"sub-resource extension": {
			lines:              []string{`+genclient:method=TraT,verb=create,subresource=bar`},
			expectedExtensions: []extension{{VerbName: "TraT", VerbType: "create", SubResourcePath: "bar"}},
		},
		"output type extension": {
			lines:              []string{`+genclient:method=TraTs,verb=list,result=Bars`},
			expectedExtensions: []extension{{VerbName: "TraTs", VerbType: "list", ResultTypeOverride: "Bars"}},
		},
		"input type extension": {
			lines:              []string{`+genclient:method=TraT,verb=update,input=Bar`},
			expectedExtensions: []extension{{VerbName: "TraT", VerbType: "update", InputTypeOverride: "Bar"}},
		},
		"unknown verb type extension": {
			lines:              []string{`+genclient:method=TraT,verb=explode`},
			expectedExtensions: nil,
			expectError:        true,
		},
		"invalid verb extension": {
			lines:              []string{`+genclient:method=TraT,unknown=bar`},
			expectedExtensions: nil,
			expectError:        true,
		},
		"empty verb extension subresource": {
			lines:              []string{`+genclient:method=TraT,verb=get,subresource=`},
			expectedExtensions: nil,
			expectError:        true,
		},
	}
