...
func (in *GenerationTokenRule) DeepCopyInto(out *GenerationTokenRule) {
	*out = *in
	...
	in.Spiffe.DeepCopyInto(&out.Spiffe)
	return
}
...
func (in *Spiffe) DeepCopyInto(out *Spiffe) {
	*out = *in
	if in.AuthorizedServiceIDs != nil {
		in, out := &in.AuthorizedServiceIDs, &out.AuthorizedServiceIDs
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraTConfig) DeepCopyInto(out *TraTConfig) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraTConfig.
func (in *TraTConfig) DeepCopy() *TraTConfig {
	if in == nil {
		return nil
	}
	out := new(TraTConfig)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TraTConfig) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraTConfigList) DeepCopyInto(out *TraTConfigList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]TraTConfig, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraTConfigList.
func (in *TraTConfigList) DeepCopy() *TraTConfigList {
	if in == nil {
		return nil
	}
	out := new(TraTConfigList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TraTConfigList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraTConfigSpec) DeepCopyInto(out *TraTConfigSpec) {
	*out = *in
	out.Token = in.Token
	in.SubjectTokens.DeepCopyInto(&out.SubjectTokens)
	out.AccessEvaluationAPI = in.AccessEvaluationAPI
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraTConfigSpec.
func (in *TraTConfigSpec) DeepCopy() *TraTConfigSpec {
	if in == nil {
		return nil
	}
	out := new(TraTConfigSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TratConfigStatus) DeepCopyInto(out *TratConfigStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TratConfigStatus.
func (in *TratConfigStatus) DeepCopy() *TratConfigStatus {
	if in == nil {
		return nil
	}
	out := new(TratConfigStatus)
	in.DeepCopyInto(out)
	return out
}
