...
func (c *Controller) handleTraTUpsert(ctx context.Context, newTraT *tokenetes1alpha1.TraT, versionNumber int64) error {
...
func (c *Controller) handleTraTUpdation(ctx context.Context, newTraT *tokenetes1alpha1.TraT, oldTraT *tokenetes1alpha1.TraT, versionNumber int64) error {
...
func (c *Controller) handleTraTDeletion(ctx context.Context, oldTraT *tokenetes1alpha1.TraT, versionNumber int64) error {
...
func (c *Controller) updateErrorTraTStatus(ctx context.Context, trat *tokenetes1alpha1.TraT, stage Stage, err error) error {
	...
	_, updateErr := c.tokenetesclientset.TokenetesV1alpha1().TraTs(trat.Namespace).UpdateStatus(ctx, tratCopy, metav1.UpdateOptions{})

	return updateErr
}

func (c *Controller) updateSuccessTratStatus(ctx context.Context, trat *tokenetes1alpha1.TraT) error {
	tratCopy := trat.DeepCopy()
...
func (c *Controller) GetActiveTraTsVerificationRules(serviceName string, namespace string) (map[string]*tokenetes1alpha1.ServiceTraTVerificationRules, error) {
	...
	serviceTraTsVerificationRules := make(map[string]*tokenetes1alpha1.ServiceTraTVerificationRules)
...
func (c *Controller) GetActiveTraTsGenerationRules(namespace string) (map[string]*tokenetes1alpha1.TraTGenerationRule, error) {
	traTs, err := c.traTsLister.TraTs(namespace).List(labels.Everything())
	if err != nil {
		c.logger.Error("Failed to list TraTs in namespace.", zap.String("namespace", namespace), zap.Error(err))
	...
	traTsGenerationRules := make(map[string]*tokenetes1alpha1.TraTGenerationRule)
