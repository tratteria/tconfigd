...
func (in *GenerationRules) DeepCopyInto(out *GenerationRules) {
	*out = *in
	if in.GenerationTratteriaConfigRule != nil {
		in, out := &in.GenerationTratteriaConfigRule, &out.GenerationTratteriaConfigRule
		*out = new(GenerationTratteriaConfigRule)
		(*in).DeepCopyInto(*out)
	}
	if in.GenerationTraTRules != nil {
		in, out := &in.GenerationTraTRules, &out.GenerationTraTRules
		*out = make([]*GenerationTraTRule, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(GenerationTraTRule)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenerationTraTRule) DeepCopyInto(out *GenerationTraTRule) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenerationTraTRule.
func (in *GenerationTraTRule) DeepCopy() *GenerationTraTRule {
	if in == nil {
		return nil
	}
	out := new(GenerationTraTRule)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenerationTratteriaConfigRule) DeepCopyInto(out *GenerationTratteriaConfigRule) {
	*out = *in
	out.Token = in.Token
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenerationTratteriaConfigRule.
func (in *GenerationTratteriaConfigRule) DeepCopy() *GenerationTratteriaConfigRule {
	if in == nil {
		return nil
	}
	out := new(GenerationTratteriaConfigRule)
...
func (in *VerificationRules) DeepCopyInto(out *VerificationRules) {
	*out = *in
	if in.VerificationTratteriaConfigRule != nil {
		in, out := &in.VerificationTratteriaConfigRule, &out.VerificationTratteriaConfigRule
		*out = new(VerificationTratteriaConfigRule)
		**out = **in
	}
	if in.VerificationTraTRules != nil {
		in, out := &in.VerificationTraTRules, &out.VerificationTraTRules
		*out = make([]*VerificationTraTRule, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(VerificationTraTRule)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerificationTraTRule) DeepCopyInto(out *VerificationTraTRule) {
	*out = *in
	if in.AzdMapping != nil {
		in, out := &in.AzdMapping, &out.AzdMapping
		*out = make(AzdMapping, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VerificationTraTRule.
func (in *VerificationTraTRule) DeepCopy() *VerificationTraTRule {
	if in == nil {
		return nil
	}
	out := new(VerificationTraTRule)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerificationTratteriaConfigRule) DeepCopyInto(out *VerificationTratteriaConfigRule) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VerificationTratteriaConfigRule.
func (in *VerificationTratteriaConfigRule) DeepCopy() *VerificationTratteriaConfigRule {
	if in == nil {
		return nil
	}
	out := new(VerificationTratteriaConfigRule)
