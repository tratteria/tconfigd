	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TratteriaV1alpha1().TraTs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TratteriaV1alpha1().TraTs(namespace).Watch(context.TODO(), options)
			},
		},
		&tratteriav1alpha1.TraT{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *traTInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tratteriav1alpha1.TraT{}, f.defaultInformer)
}
