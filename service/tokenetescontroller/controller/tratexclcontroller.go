...
func (c *Controller) handleTraTExclUpsert(ctx context.Context, newTraTExcl *tokenetes1alpha1.TraTExclusion, versionNumber int64) error {
...
func (c *Controller) handleTraTExclDeletion(ctx context.Context, oldTraTExcl *tokenetes1alpha1.TraTExclusion, versionNumber int64) error {
...
func (c *Controller) updateTraTExclErrorStatus(ctx context.Context, tratExcl *tokenetes1alpha1.TraTExclusion, err error) error {
	...
	_, updateErr := c.tokenetesclientset.TokenetesV1alpha1().TraTExclusions(tratExcl.Namespace).UpdateStatus(ctx, tratExclCopy, metav1.UpdateOptions{})

	return updateErr
}

func (c *Controller) updateTraTExclSuccessStatus(ctx context.Context, tratExcl *tokenetes1alpha1.TraTExclusion) error {
	tratExclCopy := tratExcl.DeepCopy()
...
func (c *Controller) GetActiveTraTExclRules(serviceName string, namespace string) (*tokenetes1alpha1.TraTExclRule, error) {
