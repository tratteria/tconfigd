...
func SetObjectDefaults_Defaulted(in *Defaulted) {
	...
	if in.List == nil {
		if err := json.Unmarshal([]byte(`["trat", "bar"]`), &in.List); err != nil {
			panic(err)
		}
	}
	for i := range in.List {
	...
	if in.Sub == nil {
		if err := json.Unmarshal([]byte(`{"s": "trat", "i": 5}`), &in.Sub); err != nil {
			panic(err)
		}
	}
	if in.Sub != nil {
	...
	if in.StructList == nil {
		if err := json.Unmarshal([]byte(`[{"s": "trat1", "i": 1}, {"s": "trat2"}]`), &in.StructList); err != nil {
			panic(err)
		}
	}
	...
	if in.PtrStructList == nil {
		if err := json.Unmarshal([]byte(`[{"s": "trat1", "i": 1}, {"s": "trat2"}]`), &in.PtrStructList); err != nil {
			panic(err)
		}
	}
	...
	if in.StringList == nil {
		if err := json.Unmarshal([]byte(`["trat"]`), &in.StringList); err != nil {
			panic(err)
		}
	}
	if in.OtherSub.I == 0 {
	...
	if in.Map == nil {
		if err := json.Unmarshal([]byte(`{"trat": "bar"}`), &in.Map); err != nil {
			panic(err)
		}
	}
	...
	if in.StructMap == nil {
		if err := json.Unmarshal([]byte(`{"trat": {"S": "string", "I": 1}}`), &in.StructMap); err != nil {
			panic(err)
		}
	}
	if in.PtrStructMap == nil {
		if err := json.Unmarshal([]byte(`{"trat": {"S": "string", "I": 1}}`), &in.PtrStructMap); err != nil {
			panic(err)
		}
	}
	if in.AliasPtr == nil {
